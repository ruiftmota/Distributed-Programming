# Distributed Programming Practical Assignment
...
The project itself is supposed to be similar to Spotify (very simplified version of it) but with many specifications that forbided the use 
of more apropriate tecnologies.


It is composed by the Client application that works as an interface and that establishes
the connection firstly to the Server Directory (SD) and secondly to the Server that was indentified by the SD.

It is composed by the Servers that each have their own database and are responsible to answer to all the Clients
