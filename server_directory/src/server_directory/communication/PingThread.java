...
public class PingThread extends Thread
{
    ...
    public void run() 
    {
        ...
        try
        {
            SynchronizedPrint.printLine("Started ping thread for " + serverInfo);
            ...
            while(KeepAlive.getKeepAlive())
            {
                ...
                try
                {
                    SendAndReceiveInformation.sendPing(pingRequestJson, pingSocket, InetAddress.getByName(serverInfo.getServerIp()), serverInfo.getPingPort());
                ...
                catch(SocketTimeoutException a)
                {
                    ...
                    if(conta == 3)
                    {
                        ...
                        SynchronizedPrint.printLine("Ended ping thread for " + serverInfo);
                        return;
                    }
                }
                ...
                SynchronizedPrint.printLine("Ping to " + serverInfo.getServerIp() + ":" + serverInfo.getServerPort());
    ...
    private void atualizaServerList(String requestList) throws ClassNotFoundException
    {
        ...
        if(response instanceof PingResponse)
        {
            ...
            serverDirectoryLogic.updateClientsListOfServer(serverInfo, pingResponse.getNumberOfClients());
        }
